...
function App() {
  ...
  async function startCamera(sourceId = selectedCameraSourceId) {
    ...
    try {
      ...
      if (capabilities?.focusMode?.includes("continuous")) {
        await track.applyConstraints({ advanced: [{ focusMode: "continuous" }] }).catch(() => void 0);
      }
  ...
  function selectFinalFilter(nextFilterId) {
    if (!session || nextFilterId === session.filterId || filterRendering) return;
    const updated = {
      ...session,
      filterId: nextFilterId,
      finalStripPath: void 0,
      finalStripDataUrl: void 0,
      finalGifPath: void 0,
      finalGifDataUrl: void 0
    };
  ...
  async function prepareLocalResults() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "app-shell", style: { ["--accent-color"]: settings.accentColor }, children: [
    ...
    step === "ready" && session && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "ready-layout screen-card", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "side-panel", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "detail-list", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Template" }),
    ...
    step === "capture" && session && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "capture-layout screen-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shot-list", children: Array.from({ length: template.captureCount }, (_, index) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shot-card", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shot-meta", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: remainingRetake > 0 ? `${remainingRetake} retake tersisa` : "Retake habis" })
            ] }),
    ...
    operatorOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "operator-scrim", onClick: () => setOperatorOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "operator-panel", onClick: (event) => event.stopPropagation(), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "operator-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "color", value: settings.accentColor, onChange: (event) => void updateAccentColor(event) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "operator-section", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Queue session" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "operator-section", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "operator-list", children: allSessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Belum ada sesi." }) : allSessions.slice(0, 5).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "operator-row", children: [
    ...
    template.slots.map((slot, slotIndex) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: shot.dataUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "strip-image", src: shot.dataUrl, alt: `Foto ${slot.photoIndex + 1}`, style: { filter: filterCss } }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "strip-slot-inner", style: { filter: filterCss }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Foto ",
            slot.photoIndex + 1
          ] }) })
        },
